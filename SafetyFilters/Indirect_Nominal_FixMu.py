...
@dataclass
class IndirectNominalFixMuParams:
    L: int
...
class IndirectNominalFixMuFilter(DDSafetyFilter):
    ...
    def __init__(self, 
                 sys: LinearizedErrorKinematicAcceModel, io_data: IOData, params: IndirectNominalFixMuParams,
                ) -> None:
        ...
        # terminal constraints, fix velocity to steady state value, acceleration to zero
