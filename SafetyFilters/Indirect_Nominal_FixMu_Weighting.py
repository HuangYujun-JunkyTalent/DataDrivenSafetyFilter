...
@dataclass
class IndirectNominalFixMuWeightingParams:
    L: int
...
class IndirectNominalFixMuWeightingFilter(DDSafetyFilter):
    ...
    def __init__(self, 
                 sys: LinearizedErrorKinematicAcceModel, io_data: IOData, params: IndirectNominalFixMuWeightingParams,
                ) -> None:
