...
@dataclass
class IndirectNominalFixMuWeightingAddDataParams:
    L: int
...
class IndirectNominalFixMuWeightingAddDataFilter(DDSafetyFilter):
    ...
    def __init__(self, 
                 sys: LinearizedErrorKinematicAcceModel, io_data: IOData, params: IndirectNominalFixMuWeightingAddDataParams,
                ) -> None:
