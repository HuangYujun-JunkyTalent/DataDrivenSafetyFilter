...
@dataclass
class IndirectNominalStopParams:
    L: int
...
class IndirectNominalStopFilter(DDSafetyFilter):
    ...
    def __init__(self, 
                 sys: LinearizedErrorKinematicAcceModel, io_data: IOData, params: IndirectNominalStopParams,
                ) -> None:
        ...
        constraints.append(self._u[-self._steps*self._m:] == np.zeros((l_terminal*sys._m,))) # inputs
