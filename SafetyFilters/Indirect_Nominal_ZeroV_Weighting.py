...
@dataclass
class IndirectNominalZeroVWeightingParams:
    L: int
...
class IndirectNominalZeroVWeightingFilter(DDSafetyFilter):
    ...
    def __init__(self, 
                 sys: LinearizedErrorKinematicAcceModel, io_data: IOData, params: IndirectNominalZeroVWeightingParams,
                ) -> None:
