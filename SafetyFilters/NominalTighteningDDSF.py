...
@dataclass
class NominalTighteningSFParams:
    L: int
    ...
    lam_sig: float
    epsilon: float
    a_1: float # tightening constant, usually very small
    sf_params: SFParams = SFParams()
    # use_estimated_c_pe: bool = False


class NominalTighteningDDSafetyFilter(DDSafetyFilter):
    ...
    _a_1: float # constraint tightening constant
    _io_data: IOData
    ...
    def __init__(self, sys: LTI, io_data: IOData, nominal_slack_sf_params: NominalTighteningSFParams) -> None:
